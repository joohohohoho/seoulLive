...
import org.zerock.seoulive.board.review.utils.UploadFileUtils;
...
//    } // list
    ...
    void likeList(LikeDTO dto) throws ControllerException {
        try {
...
// 2. 새로운 게시물 등록
    ...
    String writer(BoardDTO dto, MultipartFile file) throws Exception {
